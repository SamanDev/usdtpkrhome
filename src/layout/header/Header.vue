...
<template>
  <header id="header">
    <div
      id="sticky-header"
      class="menu-area transparent-header"
      :class="isSticky ? 'sticky-menu' : ''"
    >
          ...
          <div class="col-12">
            <div class="menu-wrap">
              <nav class="menu-nav">
                ...
                <div class="navbar-wrap main-menu d-none d-lg-flex"></div>
                ...
                <div @click="setSidebarOpen(true)" class="mobile-nav-toggler">
                  <i class="fas fa-bars"></i>
                </div>
              </nav>
            </div>
  ...
  <HeaderOffcanvas
    v-if="offcanvasOpen"
    @set-offcanvas-open="setOffcanvasOpen"
  />
</template>
