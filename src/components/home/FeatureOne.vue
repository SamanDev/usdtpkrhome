...
const feature_data = reactive([
  {
    id: 1,
    title: "Play Free",
    desc: "Get 3$ free chips every week.",
    img: featureImg_1,
  },
  {
    id: 2,
    title: "Fair Business",
    desc: "Get 30% rakeback + 20% refferal commissions.",
    img: featureImg_2,
  },
  {
    id: 3,
    title: "Daily League",
    desc: "$1,000 will be awarded at the end of each day to the 20 player who have earned the most points during each day.",
    img: featureImg_3,
  },
  {
    id: 4,
    title: "We Have Your Back",
    desc: "We pay 30% rakeback to players every day.",
    img: featureImg_4,
  },
]);
</script>
...
<template>
  <section id="feature" class="features-area pt-140 pb-110">
    <div class="container">
      ...
      <div class="row">
        <div v-for="item in feature_data" :key="item.id" class="col-lg-6">
          <div class="features-item">
            <div class="features-content">
              <h2 class="title">
                <router-link v-html="item.title" to="#!"></router-link>
              </h2>
              <p>{{ item.desc }}</p>
            </div>
