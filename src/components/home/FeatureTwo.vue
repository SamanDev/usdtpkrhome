...
import featureShape_1 from "/assets/img/images/features_shape01.png";
import featureShape_2 from "/assets/img/images/features_shape02.png";
...
<template>
  ...
  >
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title section-title-two text-center">
              <h2 class="title">
                At USDT Poker, you will experience the best of online poker
                using cryptocurrency. We provide you with a platform where you
                can play poker with your USDT (Tether) balance in a secure and
    ...
    <div class="features-shape-wrap">
      <img :src="featureShape_1" alt="" class="alltuchtopdown" />
      <img :src="featureShape_2" alt="" class="leftToRight" />
    </div>
  </section>
</template>
